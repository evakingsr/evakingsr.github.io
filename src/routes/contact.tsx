    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-5xl px-6 py-14">
        ...
        <a
          ...
          className="mx-auto mt-10 inline-flex w-fit items-center gap-3 rounded-full bg-[var(--berry)] px-8 py-4 text-base font-semibold text-[var(--berry-foreground)] shadow-[var(--shadow-soft)] transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
        >
